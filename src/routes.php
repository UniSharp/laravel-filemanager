...
Route::get('/laravel-filemanager/cropimage', 'Tsawler\Laravelfilemanager\controllers\LfmController@getCropimage');
Route::get('/laravel-filemanager/rename', 'Tsawler\Laravelfilemanager\controllers\LfmController@getRename');
