<ul class="list-unstyled">
  ...
  <li>
    <a class="pointer" id="folder_{{ $key }}" data-id="{{ $dir_name['long'] }}" onclick="clickFolder('folder_{{ $key }}', 0)">
      <i class="fa fa-folder folder-item" data-id="{{ $dir_name['long'] }}" id="{{ $dir_name['long'] }}-folder"></i> {{ $dir_name['short'] }}
    </a>
  </li>
  @endforeach
  ...
  <li>
    <a class="pointer" id="shared_{{ $key }}" data-id="{{ $dir_name['long'] }}" onclick="clickSharedFolder('shared_{{ $key }}', 0)">
      <i class="fa fa-folder folder-item" data-id="{{ $dir_name['long'] }}" id="{{ $dir_name['long'] }}-folder-shared"></i> {{ $dir_name['short'] }}
    </a>
  </li>
  @endforeach
</ul>
